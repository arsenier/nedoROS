...
В папке [charuco_ws/src/usb_cam](https://github.com/arsenier/nedoROS/blob/main/charuco_ws/src/usb_cam) находятся файлы с настройками камеры. Там важно изменить все параметры камеры под свою, также полезно настраивать яркость (brightness) до сборки датасета и использования распознавания объектов.
...
Высь код можно найти в файле [charuco_rectifier_node.py](https://github.com/arsenier/nedoROS/blob/main/charuco_ws/src/charuco_rectifier/charuco_rectifier/charuco_rectifier_node.py#177-234)
